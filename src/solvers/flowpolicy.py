...
class DiffusionPolicy:
    ...
    def __init__(self, num_train_timesteps, beta_schedule,  clip_sample=args.clip_sample  **kwargs):
    ...
    def train_diffusion_step(self, model, scheduler, samples, action_dim):
        ...
        noised_samples_cond = self.apply_conditioning(noised_samples, samples.conditions, dataset.action_dim)
    ...
    def infer_diffusion(self, net, dataloader_vis, dataset, logger, global_step):
        """
