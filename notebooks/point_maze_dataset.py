...
#available_datasets = minari.list_remote_datasets()
#print(available_datasets)  # Check if 'PointMaze_Medium' or similar exists
...
waypoint_controller = WaypointController(maze=env_unwrapped.maze)
